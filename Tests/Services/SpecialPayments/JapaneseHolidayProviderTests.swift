...
internal struct JapaneseHolidayProviderTests {
    ...
    @Test("元日が祝日として認識される")
    internal func 元日が祝日として認識される() throws {
    ...
    internal func 建国記念の日が祝日として認識される() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 天皇誕生日_2020年以降は2月23日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 天皇誕生日_2019年以前は12月23日() throws {
    ...
    internal func ゴールデンウィークの祝日_憲法記念日_みどりの日_こどもの日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 成人の日_2000年以降は1月第2月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 成人の日_1999年以前は1月15日() throws {
    ...
    internal func 海の日_2003年以降は7月第3月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 敬老の日_2003年以降は9月第3月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func スポーツの日_2000年以降は10月第2月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    internal func 日曜日の祝日は翌日が振替休日になる() throws {
    ...
    internal func 期間を指定して祝日を取得できる() throws {
    ...
    internal func 複数年にまたがる期間の祝日を取得できる() throws {
