...
internal struct JapaneseHolidayProviderTests {
    ...
    func 天皇誕生日_2020年以降は2月23日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func 天皇誕生日_2019年以前は12月23日() throws {
    ...
    func ゴールデンウィークの祝日_憲法記念日_みどりの日_こどもの日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func 成人の日_2000年以降は1月第2月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func 成人の日_1999年以前は1月15日() throws {
    ...
    func 海の日_2003年以降は7月第3月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func 敬老の日_2003年以降は9月第3月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func スポーツの日_2000年以降は10月第2月曜日() throws {
        let holidays2025 = provider.holidays(for: 2025)
    ...
    func 複数年にまたがる期間の祝日を取得できる() throws {
